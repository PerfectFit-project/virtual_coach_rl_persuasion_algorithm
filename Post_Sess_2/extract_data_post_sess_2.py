...
database_path = "W:/staff-umbrella/perfectfit/Exp0/2021_06_17_0739_Final_chatbot.db"

# People who gave clearly nonsensical planning/reflection answers in session 2 or 1
# We do not want to include their data
session2_nonsens_answers_p_ids = pd.read_csv("W:/staff-umbrella/perfectfit/Exp0/Final_Algorithms/2021_06_14_0736_session2_nonsensical_answers.csv")["Prolific_ID"].tolist()
session1_nonsens_answers_p_ids = pd.read_csv("W:/staff-umbrella/perfectfit/Exp0/Final_Algorithms/2021_05_29_1035_session1_nonsensical_answers.csv")["Prolific_ID"].tolist()
